...
<div class="form-clean">
	...
	<div class="panel panel-default">
		<div class="panel-heading">Tempat Diskusi dan Tanya-Jawab &nbsp; <a href="?page=forum&action=new_category?id=<?php echo $dnn1['id']; ?>" class="btn btn-warning btn-sm">Tambah Kategori</a></div>
